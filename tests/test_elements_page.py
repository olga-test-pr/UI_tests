...
#'WebTable'
    @mark.functional
    class TestWebTable:
        #'Сheck to add a person to the table'
        @mark.smoke
        ...
        #'Checking to update the persons info in the table'
        @mark.regression
        ...
        #'Checking to remove a person from the table'
        @mark.smoke
        ...
        #'Check the change in the number of rows in the table'
        @mark.regression
...
#'Buttons page'
    ...
    class TestButtonsPage:
        #'Checking clicks of different types'
        @mark.smoke
